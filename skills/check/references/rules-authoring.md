...
Each rule file lives in the `.sr-harness/rules/` directory. It declares graph edges via YAML frontmatter and contains checklist content in the markdown body.

...
This runs the full rule-based verification against `.sr-harness/rules/` to surface any
...
**Skip condition**: If `.sr-harness/rules/` does not exist, skip Step 1B and proceed

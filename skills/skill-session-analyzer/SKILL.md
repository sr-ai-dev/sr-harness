...
- Skills called (`Skill("...")`)
- Artifacts created (`.sr-harness/drafts/`, `.sr-harness/specs/`, etc.)
...
### Artifacts
- [ ] Draft file created at .sr-harness/drafts/{name}.md
- [ ] Plan file created at .sr-harness/specs/{name}.md
...
4. Verify artifacts → Check .sr-harness/
